...
class RobotJointTemplates:
    ...
    def get_hand_joints(cls, hand_type: Literal["dex3"] = "dex3") -> Dict[str, float]:
        ...
        if hand_type == "dex3":
            ...
            raise ValueError(f"Unsupported hand type: {hand_type}. Supported: 'dex3'")
...
class RobotBaseCfg:
    ...
    def get_base_config(
        ...
        Args:
            ...
            include_waist: whether to include the waist joint
            hand_type: hand type ("dex3")
            base_config: base robot configuration, default using G129_CFG_WITH_DEX3_BASE_FIX
